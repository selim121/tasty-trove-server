...
async function run() {
  try {
    ...
    const paymentCollection = client.db("TastyTroveDb").collection("payments");
...
app.get('/', (req, res) => {
  res.send('Tasty Trove is running...');
})

app.listen(port, () => {
  console.log('Tasty Trove server is running on port:' + port);
})